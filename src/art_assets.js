 ...
 *
 * 每张图必须自带对齐线，因为动态层（路人、停泊的船、浪花、建筑热区）要坐在画上：
 *   ground —— 街面基线（建筑落地、路人行走的最下沿），占图高的比例
...
export const PORT_BG_ART = {
  iberian: {
    src: '/art/ports/iberian.jpg',
    ground: 0.708, sea: 0.805, top: 0.46,
    spots: [[0.04, 0.30], [0.31, 0.51], [0.52, 0.73], [0.74, 0.98]],
  },
};
